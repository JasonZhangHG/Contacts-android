...
public class GetContactsInfoHelper {

    private static volatile GetContactsInfoHelper getContactsInfoHelper = null;

    public GetContactsInfoHelper() {
    }

    public static GetContactsInfoHelper getInstance() {
        if (getContactsInfoHelper == null) {
            synchronized (GetContactsInfoHelper.class) {
                if (getContactsInfoHelper == null) {
                    getContactsInfoHelper = new GetContactsInfoHelper();
                }
            }
        }
        return getContactsInfoHelper;
    }
